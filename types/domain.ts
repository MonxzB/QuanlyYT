...
export interface Channel {
  ...
  account?: Pick<Account, "id" | "email"> | null;
  browser_profile?: Pick<BrowserProfile, "id" | "name"> | null;
  owner?: Pick<Profile, "id" | "full_name"> | null;
}

export interface Account { id: string; email: string; recovery_email: string | null; phone: string | null; two_factor_enabled: boolean; country: string | null; source: string | null; status: string; created_at: string; updated_at: string; }
...
export interface Niche { id: string; name: string; slug: string; description: string | null; created_at: string; }
