...
export interface Video { id: string; youtube_video_id: string; channel_id: string | null; reference_channel_id: string | null; title: string; thumbnail_url: string | null; description: string | null; published_at: string; duration: string | null; view_count: number; like_count: number; comment_count: number; created_at: string; updated_at: string; last_synced_at: string | null; }
